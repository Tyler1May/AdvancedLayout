...
class StoreItemContainerViewController: UIViewController, UISearchResultsUpdating {
    ...
    @objc func fetchMatchingItems() {
        ...
        searchTask = Task {
            if !searchTerm.isEmpty {
                do {
                    try await fetchAndHandleForSearchScopes(searchScopes, withSearchTerm: searchTerm)
    ...
    func fetchAndHandleForSearchScopes(_ searchScopes: [SearchScope], withSearchTerm searchTerm: String) async throws {
